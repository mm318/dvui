...
pub fn main() !void {
    ...
    main_loop: while (true) {
        ...
        const rect: c.SDL_FRect = .{ .x = 10, .y = 10, .w = 20, .h = 20 };
        var rect2 = rect;
        ...
        _ = c.SDL_RenderLine(renderer, rect.x, rect.y + 30, rect.x + 100, rect.y + 30);
...
fn app_init() !void {
    ...
    window = c.SDL_CreateWindow(
        "DVUI SDL Ontop Example",
        @as(c_int, @intCast(640)),
        @as(c_int, @intCast(480)),
